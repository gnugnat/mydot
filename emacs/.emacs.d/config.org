...
#+BEGIN_SRC emacs-lisp
  ...
  ;; List of fonts
  (set-face-attribute 'default nil :font (font-candidate '"xos4 Terminus-10:weight=normal"
							 "Terminus-10:weight=normal"
							 "Dina-10:weight=normal"
							 "Hack-10:weight=normal"
							 "Monospace-10:weight=normal"
							 ))
#+END_SRC
** Theme
#+BEGIN_SRC emacs-lisp
